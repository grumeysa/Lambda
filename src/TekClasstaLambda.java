...
satir.map(t->t.split(" ")).
    ...
    public static void main(String[] args) {
        ...
        // Method Referansı =====> Class adı :: Method adı
        System.out.println("\nKendimizin yazdığı methodları da Method referansı olarak kullanabiliriz");
        liste.forEach(TekClasstaLambda::yazdir);
    }
    // int değer yazdıran method
